...
class Tests {
    ...
    void testSecuredAnnotationCanSeeTenantIds() {
        ...
        HttpClientResponseException thrown = assertThrows(HttpClientResponseException.class, () -> client.toBlocking().exchange(sergio));
        ...
        assertEquals("Hello World", client.toBlocking().retrieve(tim));
    }
}
